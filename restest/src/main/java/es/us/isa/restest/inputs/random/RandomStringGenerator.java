...
public class RandomStringGenerator extends RandomGenerator {
    ...
    public String nextValue() {
        ...
        switch(stringConf) {
            case 7:
                generatedString = RESTestRandom.randomAscii(stringLength);
                break;
            case 6:
                generatedString = RESTestRandom.randomAlphanumeric(stringLength);
                break;
            case 4:
                generatedString = RESTestRandom.randomAlphabetic(stringLength);
                break;
            case 2:
                generatedString = RESTestRandom.randomNumeric(stringLength);
                break;
            case 0:
                generatedString = "";
                break;
            ...
            case 3:
            case 1:
                generatedString = completeString(RESTestRandom.randomAscii(stringLength), stringConf);
                break;
            default:
    ...
    private String completeString(String firstString, int stringConf) {
        ...
        do {
            ...
            finalString += RESTestRandom.randomAscii(maxLength - finalString.length());
            switch (stringConf) {
                case 5:
