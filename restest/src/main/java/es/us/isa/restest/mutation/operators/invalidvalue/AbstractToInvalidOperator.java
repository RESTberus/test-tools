...
import es.us.isa.restest.util.RESTestRandom;
...
public abstract class AbstractToInvalidOperator extends AbstractMutationOperator {
    ...
    public static String mutate(TestCase tc, OpenAPIParameter param, String[] mutations) {
        ...
        Collections.shuffle(mutationsList, RESTestRandom.shared());

        int index = 0;
        while (index<mutationsList.size() && mutationApplied.equals("")) {
            switch (mutationsList.get(index)) {
                case REPLACE_WITH_INT:
                    String randomInt = Integer.toString(RESTestRandom.nextInt(1000, 10001));
                ...
                case REPLACE_WITH_BOOL:
                    String randomBoolean = Boolean.toString(RESTestRandom.nextBoolean());
                ...
                case REPLACE_WITH_STRING:
                    String randomString = RESTestRandom.randomAlphabetic(10, 20);
                ...
                case REPLACE_WITH_NUMBER:
                    String randomNumber = Double.toString(RESTestRandom.nextDouble(1000, 10001));
                ...
                case VIOLATE_MAX_CONSTRAINT:
                    if (param.getMax() != null) {
                        ...
                        if (param.getType().equals(NUMBER_TYPE))
                            tc.addParameter(param, Double.toString(param.getMax().doubleValue() + RESTestRandom.nextDouble(1, 10)));
                        else if (param.getType().equals(INTEGER_TYPE))
                            tc.addParameter(param, Integer.toString(param.getMax().intValue() + RESTestRandom.nextInt(1, 10)));
                    }
                    break;
                case VIOLATE_MIN_CONSTRAINT:
                    if (param.getMin() != null) {
                        mutationApplied = getMutationMessage(mutationsList.get(index), param, tc, null);
                        if (param.getType().equals(NUMBER_TYPE))
                            tc.addParameter(param, Double.toString(param.getMin().doubleValue() - RESTestRandom.nextDouble(1, 10)));
                        else if (param.getType().equals(INTEGER_TYPE))
                            tc.addParameter(param, Integer.toString(param.getMin().intValue() - RESTestRandom.nextInt(1, 10)));
                    }
                    break;
                case VIOLATE_FORMAT_CONSTRAINT:
                    if (param.getFormat() != null || param.getPattern() != null) {
                        mutationApplied = getMutationMessage(mutationsList.get(index), param, tc, null);
                        tc.addParameter(param, RESTestRandom.randomAlphabetic(10, 20));
                    }
                    break;
                case VIOLATE_MAX_LENGTH_CONSTRAINT:
                    if (param.getMaxLength() != null) {
                        mutationApplied = getMutationMessage(mutationsList.get(index), param, tc, null);
                        tc.addParameter(param, RESTestRandom.randomAlphabetic(param.getMaxLength() + RESTestRandom.nextInt(1, 11)));
                    }
                    break;
                case VIOLATE_MIN_LENGTH_CONSTRAINT:
                    if (param.getMinLength() != null && param.getMinLength() > 1) {
                        mutationApplied = getMutationMessage(mutationsList.get(index), param, tc, null);
                        tc.addParameter(param, RESTestRandom.randomAlphabetic(param.getMinLength() - 1));
                    }
                    break;
                default:
